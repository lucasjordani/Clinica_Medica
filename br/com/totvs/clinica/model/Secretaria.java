...
public class Secretaria extends Usuario {
	...
	private void cadastraConsulta() throws SQLException {
		...
		if (paciente.getNome() != null
			...
			// trazer ele do banco? Para na hora de puxar a lista de medicos e
			// pacientes e consultas
			// para o método registrar observações funcionar. MESMA COISA COM O
			// PACIENTE.
	...
	private void cadastraPaciente() throws SQLException {
		...
		System.out
				.println("Digite a data de nascimento ou Digite 0 para pular:");
